...
ItemBox.prototype.redraw = function() {
  ...
  if (this.className != className) {
    ...
    dom.box.className = 'vis_item box' + className;
    dom.line.className = 'vis_item line' + className;
    dom.dot.className  = 'vis_item dot' + className;
...
ItemPoint.prototype.redraw = function() {
  ...
  if (this.className != className) {
    this.className = className;
    dom.point.className  = 'vis_item point' + className;
    dom.dot.className  = 'vis_item dot' + className;
...
ItemRange.prototype.baseClassName = 'vis_item range';
...
ItemRangeOverflow.prototype.baseClassName = 'vis_item rangeoverflow';
