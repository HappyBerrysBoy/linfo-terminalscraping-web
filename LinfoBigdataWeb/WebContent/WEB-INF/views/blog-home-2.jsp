...
<head>
    ...
    <title>Blog Home 2 - Modern Business - Start Bootstrap Template</title>
...
<body>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="blog-home-2">Blog Home 2</a>
                            </li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h3><a href="blog-post">A Blog Home Template for Bootstrap 3</a>
                </h3>
