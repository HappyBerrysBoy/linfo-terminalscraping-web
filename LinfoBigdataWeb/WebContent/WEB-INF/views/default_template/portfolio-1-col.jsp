...
<head>
    ...
    <title>One Column Portfolio - Modern Business - Start Bootstrap Template</title>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a href="portfolio-1-col">1 Column Portfolio</a>
                            </li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <a class="btn btn-primary" href="portfolio-item">View Project <i class="fa fa-angle-right"></i></a>
            </div>
